...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-16 07:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e0dc7ae4-e0bd-416e-a384-a2f3176a23a4.git
$ cd e0dc7ae4-e0bd-416e-a384-a2f3176a23a4
```
